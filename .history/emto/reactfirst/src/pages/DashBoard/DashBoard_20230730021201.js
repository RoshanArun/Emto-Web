                ...
                <div class="dash">
                    ...
                    <div class="bottom-profile">
                        <div class='box2'>
                            ...
                            <label class="bronzeInformation">0</label><br></br>
                            <label class="bronzeInformation">0</label><br></br>
                            <label class="bronzeInformation">0</label><br></br>
                            <label class="bronzeInformation2">Bookings</label><br></br>
                            <label class="bronzeInformation2">Pending Payments</label><br></br>
                            <label class="bronzeInformation2">Points</label><br></br>
