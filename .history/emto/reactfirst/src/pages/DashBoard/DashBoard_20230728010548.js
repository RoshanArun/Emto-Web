        ...
        <div class="DashBoard">
            ...
            <div class="wrapper">
                <div class="dash">
                    ...
                    <div class="bottom2">
                        <div class="box">
                        <img src={IMAGES.booktrips} class="boximage" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.currenttTrips} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.bookedTrips} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.incomingShipments} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.payments} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.fareCalc} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.alerts} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>

                        </div>
                        <div class="box">
                        <img src={IMAGES.messages} class="" alt="dashboardlogo" /><label class="dashboardlabels">Logout</label><br></br>
