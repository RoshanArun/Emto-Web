        ...
        <div class="DashBoard">
            ...
            <div class="wrapper">
                ...
                <div class="dashboard-left">
                    ...
                    <img src={IMAGES.recievers} class="dashboardicon" alt="dashboardlogo" /><label class="dashboardlabels">Recievers</label><br></br><br></br><br></br><br></br><br></br><br></br>
                ...
                <div class="dashboard-top">
                    <label class="intro">Hello, John Peter</label><br></br><span class="small"></span>
