        ...
        <div class="DashBoard">
            ...
            <div class="wrapper">
                ...
                <div class="dashboard-left">
                    ...
                    <button class="upgrade">Upgrade</button><br></br><br></br>

                    <img src={IMAGES.settings} class="dashboardicon" alt="dashboardlogo" /><label class="dashboardlabels">Settings</label><br></br><span class="small"></span>
                ...
                <div class="dashboard-top">
                    <label class="intro">Hello, John Peter</label><br></br>
                    <label class="introsub">Track bookings here. You almost reach a goal!</label><br></br>
