            ...
            <div class="wrapper">
                <div class="dash">
                    ...
                    <div class="bottom2">
                        ...
                        <div class="box">
                        <img src={IMAGES.bookedTrips} class="boximage" alt="dashboardlogo" />

                        </div>
                        <div class="box">
                        <img src={IMAGES.incomingShipments} class="boximage" alt="dashboardlogo" />

                        </div>
                        <div class="box">
                        <img src={IMAGES.payments} class="boximage" alt="dashboardlogo" />

                        </div>
                        <div class="box">
                        <img src={IMAGES.fareCalc} class="boximage" alt="dashboardlogo" />
                        </div>
                        <div class="box">
                        <img src={IMAGES.alerts} class="boximage" alt="dashboardlogo" />

                        </div>
                        <div class="box">
                        <img src={IMAGES.messages} class="boximage" alt="dashboardlogo" />

                        </div>
                        <div class="box">
                        <img src={IMAGES.bookedTrips} class="" alt="dashboardlogo" />
